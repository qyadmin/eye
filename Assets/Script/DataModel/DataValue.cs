...
public class DataValue
{
    ...
    public ToggleGroupValue toggleGroup;
    ...
    public string GetString()
    {
        ...
        switch (MyType)
        {
            ...
            case GetTypeValue.GetFromToggleGroup:
                ValueData = toggleGroup.GetValue();
                break;
        }
        ...
        if (ValueData == string.Empty)
        {
            ...
            {
                MessageManager._Instantiate.WindowShowMessage("参数不能为空");
        ...
        switch (Rule)
        {
            case CheckType.isEqual:
                ...
                {
                    MessageManager._Instantiate.WindowShowMessage(WarmMessage);
                    return "Error";
                }
                break;
            case CheckType.rule:
